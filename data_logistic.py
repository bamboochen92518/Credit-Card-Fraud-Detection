...
from math import *
indir='/tmp2/b10902005/fintech/final/dataset_2nd/'
outdir='/tmp2/b10902085/fintech/input/'
csv_train = '/tmp2/b10902005/fintech/final/dataset_1st/training.csv'
csv_valid = indir+'public.csv'
csv_test = indir+'private_1_processed.csv'
new_csv_train = outdir+'new_train_logi.csv'
new_csv_valid = outdir+'new_valid_logi.csv'
new_csv_test = outdir+'new_test_logi.csv'
